...
const services: { label: string; detail: string }[] = [
  { label: 'Cooking Allowed', detail: 'Cook your own food with own stove in common kitchen area' },
  { label: 'Washing Machine', detail: 'Free washing machine available for all residents' },
  { label: '24/7 Water Supply', detail: 'Round-the-clock running water including hot water' },
  { label: 'Individual Cupboard', detail: 'Lockable personal cupboard for secure storage' },
  { label: 'Daily Cleaning', detail: 'Regular housekeeping and room cleaning service' },
  { label: 'CCTV & Security', detail: '24/7 CCTV surveillance and security guard' },
  { label: 'Power Backup', detail: 'Generator backup for uninterrupted electricity' },
  { label: 'WiFi Internet', detail: 'High-speed wireless internet throughout the property' },
]
      ...
      >
        ...
        >
          <div style={{ flex: '1 1 500px' }}>
            ...
            >
              From 24/7 security to daily housekeeping, every detail at Sri
              Kapotheswara is designed for your comfort and safety. A few of
              the facilities available to every resident:
            </p>
          </div>
          <div
            style={{
